...
export default function ExplorerRoleForm() {
  ...
  const handleNext = async () => {
    ...
    startTransition(async () => {
      ...
      if (isStudent) {
          router.push(`/explorer/interests?role=${encodeURIComponent(roleInput)}`);
      } else {
          router.push(`/explorer/organization?role=${encodeURIComponent(roleInput)}`);
      }
    });
  };
